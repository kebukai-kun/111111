...
module.exports = {
    config: {
        ...
        category: "fun",
        noalias: [""],
        description: "Mostra o status dos usuários",
        usage: " ",
    ...
    run: async (bot, message, args) => {
        ...
        if (!user.presence.activities.length) {
            const sembed = new MessageEmbed()
                ...
                .addField("**No Status**", 'Este usuário não possui nenhum status personalizado!')
